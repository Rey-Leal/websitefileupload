...
{
    public static bool SalvaDiretorioImagem(string codigo, string descricao)
    {
        return new Conexao().executaComando("INSERT INTO Imagens (Codigo, Descricao) VALUES ('" + codigo + "', '" + descricao + "')");
    }

    public static string RedimensionaESalva(string imagePath, int largura, int altura, string prefixo)
    {
